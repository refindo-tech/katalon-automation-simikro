...
WebUI.navigateToUrl(GlobalVariable.URL_Test_Env)
...
WebUI.verifyElementText(findTestObject('Object Repository/Page_Dashboard - Simikro/span_AdminPT_1'), Role)

WebUI.verifyElementText(findTestObject('Object Repository/Page_Dashboard - Simikro/span_AdminPT'), Role)
